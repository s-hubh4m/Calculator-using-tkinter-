...
result_entry = tk.Entry(root, textvariable=result_var, font=("Italic", 30),fg = 'black', bg = 'white', justify=tk.LEFT) #for the input expression
...
for (text, row, col) in buttons:
    button = tk.Button(root, text=text, padx=10, pady=10, font=("Italic", 8, 'bold'),fg = 'white', bg = 'black' , command= lambda t=text: on_button_click(t))
